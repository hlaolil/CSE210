...
public class Program
{
    public static void Main()
    {
        ...
        var listingActivity = new ListingActivity("Listing Exercise", "List responses to a prompt.", 10, listingPrompts);
        ...
        var reflectingActivity = new ReflectingActivity("Reflection Exercise", "Reflect on prompts and questions.", 10, reflectingPrompts, reflectingQuestions);
